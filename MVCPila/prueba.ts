...
class Punto {
    ...
    mejorRuta(voyA: Punto, miLista: Punto[], mapa: Map<number, Punto>, todasRutas:listaRutasNodos, estacionAnterior2?: Punto): Punto[] | undefined {
        miLista.push(this)
        ...
        for (let i = 0; i < this.puntosColindantes.length; i++) {
            ...
            if(nodo !== estacionAnterior2 ){
                let resultado = nodo.mejorRuta(voyA, miLista, mapa, todasRutas, this)
                return
            }
            miLista.pop()
        }
...
nuevoPunto.mejorRuta(puntoSeis, lista, miMapa, miListaRutas, undefined)
